...
export const CreatePage = () => html`
  ...
  <div class="row">
    ...
    <hr />
    <button id="toggle-configuration-page" class="labelButton light-shadow">${ManageAccountLogo()} Configure</button>
  ...
  <div id="create-page-two" style="display: none;">
    <button class="accordion">
      ${accordionButtonImageAligner(() => AcceptedSmartContractLogo("40"), "Smart Contract (Required)")}
    </button>
    <div class="panel">
      <small>You must use a smart contract. You can deploy it on any EVM compatible network.</small>
    ...
    <div class="panel">
      <small>Select sanctioned countries to block from signing the contract. You can select a group of countries when
        selecting the sanctions or select them one by one.</small>
      <table class="input-table" aria-label="input field container table">
        <tr>
          <th></th>
          <th></th>
        ...
        <tr>
          ...
          <td>
            <input aria-label="Expires date input" name="expires" id="expires-input" class="cursor-pointer" type="date" />
            <button aria-label="never expires button" name="never" class="cursor-pointer labelButton" id="expires-reset">
              ${neverLogo()} Never
            </button>
          </td>
          <td>
      ...
      <small>Don't forget to set the expiry date. By default the contract expires in 1 day. Select a specific date or
        click never to disable expiry.</small>
      <hr />
    </div>
    <hr />
    <button class="accordion">
    ...
    <div class="panel">
      <small>Redirect to your website after contract signing. The user will be prompted to navigate to the new
        page.</small>
      <table class="input-table" aria-label="input field container table">
        <tr>
          <th></th>
        ...
        <tr>
          ...
          <td>
            <table class="width-100Percent">
              <tr>
                <td>
                  <input aria-label="Related trail" name="trail" id="trail-input" type="text" placeholder="Trail Name"
                    class="cursor-text" />
                </td>
              </tr>
              <tr>
                <td>
                  <input aria-label="Arweave address for trail" name="trail" id="trail-address-input" type="text"
                    placeholder="Arweave address" class="cursor-text" />
                </td>
              </tr>
            </table>
          </td>
      ...
      <small>Trails can be added to unlock commenting on a ricardian contract. Users can add comments and link
        transactions to a trail. When a trail is added to the ricardian contract users can navigate to it with a link.
      </small>
      <hr />
    </div>
    ...
    <button id="erc20configurationButton" class="accordion">
      ${accordionButtonImageAligner(() => Erc20Logo("40", "40"), "ERC-20 support")}
    </button>
    <div class="panel">
      <small>When signing the contract, the user can be prompted to add a new ERC-20 token to the wallet.</small>
      <table id="erc20-table">
        ...
        <tr>
          ...
          <td>
            <input id="erc20-name" type="text" aria-label="erc20 name input" placeholder="..." />
          </td>
        ...
        <tr>
          ...
          <td>
            <input id="erc20-symbol" aria-label="erc20 symbol" placeholder="..." type="text" />
          </td>
        ...
        <tr>
          ...
          <td>
            <input aria-label="erc20 decimal input" placeholder="18" id="erc20-decimals" type="number" />
          </td>
        ...
        <tr>
          ...
          <td>
            <input aria-label="erc20 contract address input" placeholder="0x" id="erc20-address" type="text" />
    ...
    <hr />
    <button class="accordion">
      ${accordionButtonImageAligner(() => uploadLogo("40", "40"), "Uploading (Required)")}
    </button>
    <div class="panel">
      <small>You must enter your wallet password to upload the legal contract to Arweave. If you don't have one, create it
        using the burner wallet in the permaweb dropdown.</small>
